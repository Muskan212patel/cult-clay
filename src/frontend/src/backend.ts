...
export class Backend implements backendInterface {
    ...
    async addEmail(arg0: string, arg1: string): Promise<AddEmailResult> {
        if (this.processError) {
            try {
                const result = await this.actor.addEmail(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getEmailCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getEmailCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getEmails(): Promise<Array<EmailSignup>> {
        if (this.processError) {
            try {
